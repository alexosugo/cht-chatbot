...
class RAGChain:
    ...
    def __init__(
        ...
        self.qa_template = PromptTemplate(
            template="""You are a helpful assistant for the Community Health Toolkit (CHT).
            Use the following pieces of context to answer the question at the end.
            If you don't know the answer, just say that you don't know, don't try to make up an answer.
            Always cite your sources by mentioning the title and URL of the documentation pages you used.
    ...
    async def answer_question(
        ...
        response = await self.chain.ainvoke({
            "question": question,
            "chat_history": [] if not use_history else None
        })
