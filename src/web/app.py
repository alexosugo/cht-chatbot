...
# Configure page
st.set_page_config(
    page_title="CHT Documentation Assistant", page_icon="🤖", layout="wide"
)
...
async def process_question(
    rag_chain: RAGChain, question: str, history: list
) -> Dict[str, Any]:
...
def main():
    ...
    with st.sidebar:
        ...
        st.markdown(
            """
            This assistant helps you find information in the Community Health
            Toolkit documentation. Ask questions about CHT, and I'll provide
            answers with relevant source links.
            """
        )
